...
<html>
	<head>
		...
		<script>
			history.replaceState('', 'AS1881 - Calendrier - {$GP_name}', ' {$loginURL} ');
		</script>
	</head>
	<header>
		<img class="header-logo" src="logo-as1881.svg" alt="logo-AS1881"/>
	</header>
	<body>
...
{else}
		<div class="content">
			<div class="introduction">
				Bienvenue sur la page des évènements internes du club Aviron Strasbourg 1881.<br/>
			</div>
			<div class="notice">
...
{if $oneFilterActive > 0}<a href="{$loginURL}" >Réinitialiser les {$oneFilterActive} filtre(s)</a>{/if}</div>
			...
			<div class="card {$card.categorie}">
							...
							<div class="cell">Rappel : les séances de tank à ramer ont lieu à la piscine de Schiltigheim.<br/>Rappel : Si arrivée à ou après 19h, Contacter Pierre pour se signaler.</div>
						</div>
			{else}
