...
{include file='bs-comp-edition.tpl'}
  <div class="card-body">
  <h5 class="card-title"><span class="badge bg-secondary">Officiel</span> Séance d'avifit</h5>{if $card.referee ne ''}<h6 class="card-subtitle mb-2 text-muted">Animée par <b>{$card.referee}</b></h6>{/if}
